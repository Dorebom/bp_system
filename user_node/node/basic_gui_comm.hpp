...
#include "../data_struct/state/st_gui_comm_state.hpp"
#include "../data_struct/cmd/st_gui_comm_cmd.hpp"

#include <random>

class BasicGuiComm : public b_node
{
private:
...
public:
    ...
    std::shared_ptr<b_node> Clone() const override{
        return std::make_shared<BasicGuiComm>(*this);
    }
};  // class BasicGuiComm